  ...
  methods: {
    ...
    updateKodeKabupatenKota() {
      const selected = this.kabupatenKotaList.find(
        (item) => item.nama === this.pengangguranterbuka.nama_kabupaten_kota
      );
      this.pengangguranterbuka.kode_kabupaten_kota = selected ? selected.kode : "";
    },
  },
  components: {
    NavbarDashboard,
          ...
          <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
            ...
            <div class="w-full">
              ...
              <input
                ...
                v-model="pengangguranterbuka.kode_kabupaten_kota"
