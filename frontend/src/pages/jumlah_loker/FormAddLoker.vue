...
export default {
  ...
  methods: {
    async handleSubmit() {
      ...
      try {
        const response = await axios.post("http://localhost:5001/api/loker", this.form);        
        alert("Data berhasil ditambahkan.");
        this.$router.push("/jum-loker");
  ...
  <div>
    ...
    <section class="bg-white dark:bg-gray-900">
      <div class="max-w-2xl px-4 py-8 mx-auto lg:py-16">
        <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Tambah Data Jumlah Lowongan Kerja</h2>
        ...
        <form @submit.prevent="handleSubmit">
          <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
            ...
            <div class="sm:col-span-2">
              <label for="jumlah_lowongan_kerja" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                Jumlah Lowongan Kerja
              </label>
              <input
                v-model="form.jumlah_lowongan_kerja"
