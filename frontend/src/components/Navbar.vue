    ...
    <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <a href="" class="flex items-center">
                ...
                <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Jabar Workforce</span>
            </a>
                ...
                <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                    ...
                    <li class="relative group">
                        ...
                        <ul class="absolute left-0 z-10 hidden w-48 bg-white border border-gray-100 rounded-lg shadow-lg group-hover:block">
                            <li>
                                <router-link to="/" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Jumlah Lowongan Kerja</router-link>
                            </li>  
                            <li>
