                ...
                <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">  
                    ...
                    <li class="relative group">
                        ...
                        <ul class="absolute left-0 z-10 hidden w-48 bg-white border border-gray-100 rounded-lg shadow-lg group-hover:block">
                            <li>
                                <router-link to="/chart-loker" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Jumlah Lowongan Kerja</router-link>
                            </li>  
                            <li>
                                <router-link to="/chart-upah-minimum" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Daftar Upah Minimum</router-link>
                            </li>    
                            <li>
                                <router-link to="/chart-pengangguran-terbuka" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Pengangguran Terbuka</router-link>
                            </li>  
                            <li>
                                <router-link to="/chart-registered-jobseeker" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Jumlah Pencari Kerja Terdaftar</router-link>
                            </li>                                                  
                            <li>
                                <router-link to="/" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Dashboard</router-link>
                            </li>                                                  
                        </ul>
                    </li>
                    <li class="relative group">
                        <a href="#" class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Data Jabar</a>
                        <!-- Submenu -->
                        <ul class="absolute left-0 z-10 hidden w-48 bg-white border border-gray-100 rounded-lg shadow-lg group-hover:block">
                            <li>
                                <router-link to="/jum-loker" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Jumlah Lowongan Kerja</router-link>
                            </li>  
                            <li>
